...
class TestInterfaceImprovements(unittest.TestCase):
    ...
    def test_single_window_uses_direct_console_panel_and_scale_palette(self) -> None:
        ...
        self.assertIn("_build_panel_section_button(\"ESCALAS\", 1)", display_panel_source)
        self.assertNotIn("_build_panel_section_button(\"VISUALIZACION\", 2)", display_panel_source)
        ...
        self.assertNotIn("display_panel_scale_select_button", display_panel_source)
        self.assertNotIn("display_panel_transpose_spin", display_panel_source)
        self.assertNotIn("display_panel_on_top", display_panel_source)
        self.assertNotIn("display_panel_midi_learn", display_panel_source)
        self.assertNotIn("display_panel_single_bg_button", display_panel_source)
        self.assertNotIn("display_panel_keyboard_labels", display_panel_source)
